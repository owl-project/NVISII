...
soup_mesh = visii.mesh.create_from_obj("soup", "models/Ketchup/google_16k/textured.obj")
soup_texture = visii.texture.create_from_image('soup',"models/Ketchup/google_16k/texture_map.png")
...
soup_entity.get_transform().set_scale(0.1)
...
soup_col_id = p.createCollisionShape(p.GEOM_MESH,
    meshScale = [0.1,0.1,0.1],
    fileName = "models/Ketchup/google_16k/textured.obj"
    )
